...
class FeedLikeControllerTest {
    ...
    private void feedLikeToggle(final int result) throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(get(BASE_URL).queryParams(getParameter())); //queryParams: 쿼리스트링으로 들어오는값 확인
    ...
    private MultiValueMap<String, String> getParameter() {
        ...
        queryParams.add("feedId", String.valueOf(feedId_2)); //쿼리스트링 만들기
        return queryParams;
    }
